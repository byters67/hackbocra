    ...
    <div className="bg-white">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 pb-0"><div className="relative py-10 sm:py-14 px-5 sm:px-8 lg:px-10 rounded-2xl overflow-hidden bg-gradient-to-br from-[#00458B] to-[#003366]">
        ...
        <div ref={heroRef} className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">{tn ? 'Potala ya Tsamaiso ya Sepeketerama' : 'Spectrum Management Portal'}</h1>
          ...
          {user ? (
            <>
              <button onClick={() => setView('dashboard')} className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-[#6BBE4E] hover:shadow-lg transition-all text-left group">
                ...
                <h2 className="text-lg font-bold text-bocra-slate group-hover:text-[#6BBE4E]">{tn ? 'Ya kwa Potala' : 'Go to Portal'}</h2>
              ...
              <button onClick={() => setView('register')} className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-[#00458B] hover:shadow-lg transition-all text-left group">
                ...
                <h2 className="text-lg font-bold text-bocra-slate group-hover:text-[#00458B]">{tn ? 'Kwadisa Khampani e Ntšha' : 'Register New Company'}</h2>
      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-white rounded-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <p className="text-xs text-center text-gray-400">Already have an account? <button type="button" onClick={() => setView('login')} className="text-[#00458B] font-medium hover:underline">{tn ? 'Tsena' : 'Sign In'}</button></p>
          </form>
        </div>
      </div>
    </div>
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <p className="text-xs text-center text-gray-400">Don't have an account? <button type="button" onClick={() => setView('register')} className="text-[#6BBE4E] font-medium hover:underline">{tn ? 'Bula Akhaonto' : 'Create Account'}</button></p>
          </form>
        </div>
      </div>
    </div>
...
function OperatorDashboard({ operator, user, signOut, setView }) {
  ...
  return(<div className="bg-bocra-off-white min-h-screen">
    ...
    <div className="section-wrapper py-6">
      ...
      {activeTab==='overview'&&<><div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6"><div className="bg-white rounded-xl border border-gray-200 p-4"><p className="text-2xl font-bold text-bocra-slate">{applications.length}</p><p className="text-xs text-gray-400">{tn ? 'Dikopo' : 'Applications'}</p></div><div className="bg-white rounded-xl border border-gray-200 p-4"><p className="text-2xl font-bold text-[#6BBE4E]">{applications.filter(a=>a.status==='approved').length}</p><p className="text-xs text-gray-400">Approved</p></div><div className="bg-white rounded-xl border border-gray-200 p-4"><p className="text-2xl font-bold text-[#F7B731]">{applications.filter(a=>a.status==='pending').length}</p><p className="text-xs text-gray-400">Pending</p></div><div className="bg-white rounded-xl border border-gray-200 p-4"><p className="text-2xl font-bold text-bocra-slate">{complaints.length}</p><p className="text-xs text-gray-400">{tn ? 'Dingongorego' : 'Complaints'}</p></div></div>
