...
export default function FileComplaintPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Server handles: rate limiting, reCAPTCHA verification, sanitization, DB insert, AI classification
      ...
      <div className="bg-bocra-off-white border-b border-gray-100">
        <div className="section-wrapper py-4">
          <nav className="text-sm text-bocra-slate/50 flex items-center gap-2">
            ...
            <ChevronRight size={14} />
            <span className="text-bocra-slate">File a Complaint</span>
          </nav>
        </div>
      </div>
      {/* Hero */}
      <PageHero category="COMPLAINTS" title="File a Complaint" description="Report a service issue with your telecommunications, broadcasting, or postal service provider. BOCRA will investigate on your behalf." color="magenta" />
