...
import { ChevronRight, Search, Calendar, ArrowRight, Tag } from 'lucide-react';
...
const PLACEHOLDER_NEWS = [
  {
    id: 1, title: 'BOCRA Website Development Hackathon', category: 'Announcement',
  ...
  {
    id: 2, title: 'SADC Roaming Tariff Reductions Take Effect', category: 'Consumer',
  ...
  {
    id: 3, title: 'Expression of Interest: Supplier Database 2026/27', category: 'Procurement',
  ...
  {
    id: 4, title: 'BTC Announces Reduced Data Prices', category: 'Industry',
  ...
  {
    id: 5, title: 'ITA Broadcasting Licence Issued', category: 'Licensing',
    date: '2026-01-20', excerpt: 'BOCRA issues a new broadcasting licence to ITA, expanding media options for Botswana consumers.',
  },
  {
    id: 6, title: 'Orange Botswana Reduced Data Prices', category: 'Industry',
  ...
  {
    id: 7, title: 'Commercial Radio Licensing Framework Update', category: 'Licensing',
...
const CATEGORIES = ['All', 'Announcement', 'Consumer', 'Industry', 'Licensing', 'Procurement', 'Publication'];
      ...
      <div className="bg-bocra-off-white border-b border-gray-100">
        <div className="section-wrapper py-4">
          <nav className="text-sm text-bocra-slate/50 flex items-center gap-2">
            ...
            <span className="text-bocra-slate">News & Events</span>
          </nav>
        </div>
      </div>
