            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div>
                ...
                <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { title: 'Passive Sharing', desc: 'Sharing of physical infrastructure such as towers, masts, poles, ducts, and buildings. Operators co-locate equipment on shared structures.', icon: Building, color: '#00A6CE' },
                    { title: 'Active Sharing', desc: 'Sharing of active network elements such as radio access networks (RAN), antennas, and transmission equipment.', icon: Signal, color: '#C8237B' },
                    { title: 'Fibre Sharing', desc: 'Shared use of fibre optic networks and ducts. BoFiNet provides the national backbone for wholesale access.', icon: Globe, color: '#6BBE4E' },
                    { title: 'Spectrum Sharing', desc: 'Arrangements for shared or coordinated use of radio frequency spectrum resources to maximise efficiency.', icon: Wifi, color: '#F7B731' },
                  ].map(type => (
